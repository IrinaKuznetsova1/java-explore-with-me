...
public class RequestService {
    ...
    public EventRequestStatusUpdateResult updateRequestsStatus(long eventId,
        ...
        requestsToUpdate.forEach(req -> {
            if (req.getStatus() == RequestStatus.PENDING && request.getStatus() == RequestStatus.REJECTED) {
                req.setStatus(RequestStatus.REJECTED);
                requestRepository.save(req);
                rejectedRequests.add(req);
            } else if (req.getStatus() == RequestStatus.PENDING && request.getStatus() == RequestStatus.CONFIRMED) {
